    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data History Service Kendaraan</h3>
                <p class="text-subtitle text-muted">
                    Data History Service Kendaraan
                </p>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h4>Filter Data</h4>
                            <form action="<?= base_url() ?>/data/history_action" method="post">
                                <?= csrf_field() ?>
                                <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title">Data History Service Kendaraan</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
