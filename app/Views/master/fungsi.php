            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title">Master Fungsi</h4>
...
<div class="modal fade text-left" id="tambah" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>/master/fungsi_store" method="POST">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fungsi" id="fungsi" class="form-control" placeholder="Fungsi">
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade text-left" id="edit<?= $r->no ?>" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>/master/fungsi_update" method="POST">
                    <?= csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="fungsi">Fungsi</label>
                                <input type="text" name="fungsi" id="fungsi" class="form-control" placeholder="Fungsi" value="<?= $r->fungsi ?>">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade text-left" id="delete<?= $r->no ?>" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>/master/fungsi_delete" method="POST">
                    <?= csrf_field(); ?>
                    <div class="modal-body">
                        <div class="modal-body">
                            <div class="form-group">
